<script>
	let { text = 'Replace Me!', href = '#' } = $props();
</script>

<a {href} class="group relative inline-block">
	<button
		class="relative cursor-pointer overflow-hidden rounded-2xl border-2 border-white/50 bg-emerald-200/30 px-40 py-4 text-xl font-bold text-white transition-all duration-300 hover:border-white/50"
	>
		<span
